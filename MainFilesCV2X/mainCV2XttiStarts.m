...
if ~isempty(stationManagement.transmittingIDsCV2X)
        ...
        %hdy for debuging
    for ix = 1:length(stationManagement.transmittingIDsCV2X)
        nowcar=stationManagement.transmittingIDsCV2X(ix);
        p2rRBid=hdyCalc([positionManagement.XvehicleReal(nowcar); positionManagement.YvehicleReal(nowcar)], ...
            simValues.angle(nowcar), ...
            simValues.v(nowcar), ...
            nowcar, ...
            4, ...
            6, ...
            ...
            timeManagement.elapsedTime_TTIs, ...
            simValues.spsORp2r(nowcar),simValues.whenSelectRrc(nowcar), ...
            stationManagement.BRid(nowcar,stationManagement.pckNextAttempt(nowcar)), ...
            stationManagement.resReselectionCounterCV2X(nowcar) );
    end
